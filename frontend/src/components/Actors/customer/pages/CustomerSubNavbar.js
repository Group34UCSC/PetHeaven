    ...
    return(
        <div class="bg-light" id="subnavarea">
            <ul class="nav nav-pills nav-fill">
                ...
                <Link to="/SignUp/findapet"><a class="bg-warning nav-link active" aria-current="page" href="#">Find pets<i class="fa fa-dog"></i></a></Link>
                </li>
                <li class="nav-item" id="custsubnaitem">
                <Link to="/SignUp/findapet/findpettoolstore"><a class="text-dark nav-link" href="#">Veteranians<i class="fa fa-stethoscope"></i></a></Link>
                </li>
                <li class="nav-item" id="custsubnaitem">
                <Link to="/SignUp/findapet/findpharmacy"><a class="text-dark nav-link" href="#">Pharmacies <i class="fa-solid fa-prescription-bottle-medical"></i></a></Link>
                </li>
                <li class="nav-item" id="custsubnaitem">
