...
function CustomerAdoptRequest() {
    return(
        <div>
            ...
            <h1 class=" col-sm-12 requestheader">Adopt Request form</h1>
            <h2 class="col-sm-12 requestdescription"> Fill this form with correct information.<br></br> PetHeaven team 
            will send you a notification whether you can take this pet or not</h2>
            <div>
                <form class="requestform border-top border-bottom border-success">
                    <div class="formrows row">
                    ...
                    <div class="formrows row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="formareaform-control" id="inputfirstname"></input>
                        </div>
                    </div>
